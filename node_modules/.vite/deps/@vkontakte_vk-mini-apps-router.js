...
function useHistoryManager() {
  const { viewHistory } = (0, import_react11.useContext)(RouterContext);
  const historyManager = (0, import_react11.useMemo)(() => new HistoryManager(viewHistory), [viewHistory]);
